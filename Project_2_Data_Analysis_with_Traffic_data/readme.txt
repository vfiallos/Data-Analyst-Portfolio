...
Step 1: The main file to run is called Finding Heavy Traffic Indicators on I-94.ipynb
		 
	First upload the dataset Metro_Interstate_Traffic_Volume.csv.gz. Finding Heavy Traffic Indicators on I-94.ipynb file is already present. Just open the folder in Jupyter Notebook and start running each cell of Finding Heavy Traffic Indicators on I-94.ipynb. 
